...
export default function SnippetPageClient({ params }) {
  const { id } = use(params);
  ...
  async function handleTogglePublic() {
    ...
    try {
      await fetch(`/api/snippets/${id}/public`, { method: "PATCH" });
    } catch {
      setIsPublic((prev) => !prev);
    } finally {
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className={`inline-flex items-center gap-1.5 px-3 py-1.5 text-sm border rounded-lg transition-colors ${
                  isPublic
                    ? "text-[#3fb950] border-[#3fb95044] bg-[#0c2d1b] hover:bg-[#0c3d20]"
                    : "text-[#8b949e] border-[#30363d] hover:bg-[#161b22] hover:text-[#3fb950]"
                }`}
              >
